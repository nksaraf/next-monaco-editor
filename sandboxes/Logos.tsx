...
export function GraphQLogo({ color }: { color: string }) {
  return (
    <svg
      color={color}
      viewBox="0 0 400 400"
...
export const FaunaDBLogo = (props: any) => (
  <svg width="100%" height="100%" viewBox="0 0 19 23" fill="none" {...props}>
    <path
      d="M1.902 8.467L0 0l11.72 9.153 1.989-2.53 2.536-.493L19 5.595l-2.755 4.158v5.595L2.143 23l3.87-6.066 3.63-2.187-3.783.88-3.258-5.402 6.756 1.822"
      fill="#fff"
    />
  </svg>
);
